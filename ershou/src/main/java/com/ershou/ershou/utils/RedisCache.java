...
public class RedisCache {
     ...
     * @return
     */
    public boolean deleteObject(final Collections collection) {
     ...
     * @return 缓存的对象
     */
    public <T> long setCahcheList(final String key, final List<T> dataList) {
     ...
     * @return 缓存键值对应的数据
     */
    public <T> List<T> getCahcheList(final String key) {
